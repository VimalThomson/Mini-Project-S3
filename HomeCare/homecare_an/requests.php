...
$result = mysqli_query($con, "SELECT * FROM `users` join `role_db` on users.role_id=role_db.role_id join `worker` on worker.role_id=role_db.role_id WHERE role_db.status=2");
 ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="common-div">
        ...
        <tr>
            ...
            <th style="text-align: center;">Certificate Id</th>
